            ...
            <div className=" bg-[#f7f8ff]  rounded-2xl">
                <div className='p-3 flex items-center justify-around'>
                    <div onFocus={() => setIsClicked(true)} onBlur={() => setIsClicked(false)}
                        ...
                        <input className={`w-full lg:text-2xl text-lg font-bold rounded-xl py-6 bg-white shadow-2xl focus:outline-blue-700 transition-all duration-200
                                ${isClicked ? "pl-2 pr-80" : "pl-4 md:pl-18 lg:pl-18 md:pr-80 lg:pr-80"}`} type="text"

                            placeholder='Type the domain you want' />

                        <button className='absolute top-1/2 -translate-y-1/2 right-0 md:right-2 lg:right-2 bg-[#09757A] flex items-center gap-2
                         text-white text-base font-medium rounded-r-xl lg:rounded-lg md:rounded-lg p-6 lg:px-4 lg:py-5 md:px-4 md:py-5 cursor-pointer'>
