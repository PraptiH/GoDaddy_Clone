import meganav from '../../assets/img-meganav-websites.avif'
            ...
            <div className={mobile ? "grid grid-cols-1 gap-5" : "grid grid-cols-4 px-16 my-10"}>
                    ...
                    <div className="flex flex-col gap-1 lg:gap-10 mt-5">
                        <div className="flex items-start gap-2 cursor-pointer hover:bg-white lg:hover:bg-[#F5F5F5] p-1.5 rounded-xl mx-2">
                            ...
                            <div className="space-y-1">
                                <p className="text-base font-medium">Website Builder</p>
                        ...
                        <div className="flex items-start gap-2 cursor-pointer hover:bg-white lg:hover:bg-[#F5F5F5] p-1.5 rounded-xl mx-2">
                            ...
                            <div className="space-y-1">
                                <p className="text-base font-medium">Website Template</p>
                        ...
                        <div className="flex items-start gap-2 cursor-pointer hover:bg-white lg:hover:bg-[#F5F5F5] p-1.5 rounded-xl mx-2">
                            ...
                            <div className="space-y-1">
                                <p className="text-base font-medium">Online Store</p>
                                <p className="text-xs">Sell products, services and let customers book appointments in online.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div className="flex flex-col mt-5">
                        <div className="flex items-start gap-2 cursor-pointer hover:bg-white lg:hover:bg-[#F5F5F5] p-1.5 rounded-xl mx-2">
                            ...
                            <div className="space-y-1">
                                <p className="text-base font-medium">Airo AI Builder</p>
                                <p className="text-xs">Your conversational business companion that build customized sites and web apps in minutes</p>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div className="flex flex-col mt-5">
                        <div className="flex items-start gap-2 cursor-pointer hover:bg-white lg:hover:bg-[#F5F5F5] p-1.5 rounded-xl mx-2">
                            ...
                            <div>
                                <p className="text-base font-medium">Website Design Services</p>
                                <p className="text-xs">Let our experts design and build your custom site</p>
                            </div>
                        </div>
                ...
                <div className='space-y-3 group cursor-pointer'>
                    <div className="overflow-hidden rounded-lg shadow-md">
                        <img src={meganav} className="group-hover:scale-105 transition-all duration-300 "
                        />
                    </div>


                    <p className='font-semibold text-lg group-hover:underline'>How to create website</p>
                </div>
            </div>
        </>
    )
