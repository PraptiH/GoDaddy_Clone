                ...
                <div>
                    ...
                    <div className="flex flex-col gap-5 mt-5">
                        ...
                        <div className="flex items-center gap-2 cursor-pointer hover:bg-[#F5F5F5] p-1.5 rounded-xl mx-2">
                            ...
                            <p className="text-base font-medium">GTLD Domain Extensions</p>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-5 mt-5">
                        ...
                        <div className="flex items-center gap-2 cursor-pointer hover:bg-[#F5F5F5] p-1.5 rounded-xl mx-2">
                            ...
                            <p className="text-base font-medium">Discount Domain Search</p>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-5 mt-5">
                        ...
                        <div className="flex items-center gap-2 cursor-pointer hover:bg-[#F5F5F5] p-1.5 rounded-xl mx-2">
                            ...
                            <p className="text-base font-medium">Bulk Domain Search</p>
                        </div>
                    </div>
