...
function DomainMegaMenu({mobile}:Mobile) {
    return (
        <>
            <div className={mobile? "flex flex-col gap-5": "flex flex-row justify-between px-12"}>
                <div className="m-5">
                    ...
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-base font-semibold">Search for Domain Names</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-base font-semibold">Transfer Domain Names</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-base font-semibold">GTLD Domain Extensions</p>
                        </div>
                    </div>
                ...
                <div className="m-5">
                    ...
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-base font-semibold">Auctions for Domain Names</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-base font-semibold">Appraise Domain Name Value</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-base font-semibold">Discount Domain Search</p>
                        </div>
                    </div>
                ...
                <div className="m-5">
                    ...
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-base font-semibold">Find a Domain Owner (WHOIS)</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-base font-semibold">Generate Domain Names</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-base font-semibold">Bulk Domain Search</p>
                        </div>
                    </div>
