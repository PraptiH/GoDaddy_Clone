                ...
                <div>
                    ...
                    <div className="flex flex-col gap-5 mt-5">
                        ...
                        <div className="flex items-center gap-2  cursor-pointer hover:bg-[#F5F5F5] p-1.5 rounded-xl mx-2">
                            ...
                            <p className="text-base font-medium">Unified Inbox</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-5 mt-5">
                        <div className="flex items-start gap-2  cursor-pointer hover:bg-[#F5F5F5] p-1.5 rounded-xl mx-2">
                            ...
                            <div className="space-y-1">
                                <p className="text-base font-medium">Airo</p>
                                <p className="text-xs">Launce your brand quickly with a domain, logo, and social media marketing.</p>
                            </div>
                        </div>
