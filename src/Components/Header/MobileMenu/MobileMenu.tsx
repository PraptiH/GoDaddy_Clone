...
function MobileMenu({ isMenuOpen, closeMenu }: Props) {
    ...
    return (
        <>
            ...
            <div className={`fixed top-0 left-0 h-screen scrollbar-none w-[50%] max-w-2xl overflow-hidden bg-white z-50 transition-transform duration-300
            ...
            {isMenuOpen && (
                <button onClick={closeMenu} className=" fixed top-0 left-[calc(50vw+2px)] z-50 text-white text-4xl cursor-pointer">
