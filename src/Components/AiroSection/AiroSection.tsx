...
function AiroSection() {
    return (
        <>
            <div className="mx-5 space-y-4 relative my-20">
                <h1 className="font-bold text-5xl tracking-wide mb-5">Airo every day, all the way</h1>
                <img className='object-cover rounded-3xl w-full' src={customerDesktop} alt="" />

                <div className='bg-white px-10 py-15 rounded-xl absolute top-1/2 -translate-y-1/2 w-1/2 h-150 right-8 my-9'>
                    <h2 className='text-black text-2xl font-bold tracking-wide leading-normal'>“It's my job to make you believe I can do anything. But when it came to building my website, GoDaddy Airo™ stepped in and turned my vision into reality.”</h2>

                    <div className='my-15 flex items-center justify-between gap-5'>
                        ...
                        <div className=' w-4/6 h-70'>
                            <img className=' h-70 object-cover rounded-xl' src={customerThumbnail} alt="" />
                        </div>
                    </div>
                </div>
            </div>
